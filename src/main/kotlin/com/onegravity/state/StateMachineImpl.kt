...
@Suppress("unused")
class StateMachineImpl<STATE : Any, EVENT : Any, SIDE_EFFECT : Any> constructor(
    ...
    private fun with(init: GraphBuilder<STATE, EVENT, SIDE_EFFECT>.() -> Unit): StateMachine<STATE, EVENT, SIDE_EFFECT> {
        return createStateMachine(graph.copy(initialState = getState()), init)
    }
